        ...
        <div class="card-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="mb-3">
              ...
              <textarea  style="min-height: 200px" v-model="post.content" id="post-content" class="form-control"></textarea>
              <div class="text-danger mt-1">
                {{ errors.content }}
              </div>
              <div class="text-danger mt-1">
            ...
            <div>
              Details
              <div>
                <ckeditor :editor="editor" v-model="post.details" :config="editorConfiguration"></ckeditor>
            ...
            <div class="mb-3">
              ...
              <v-select multiple v-model="post.versions" :options="versionList" :reduce="version => version.id"
                        label="name" class="form-control"/>
              <div class="text-danger mt-1">
                {{ errors.versions }}
              </div>
