    ...
    <div class="col-md-12">
      <div class="card border-0">
        <div class="card-header bg-transparent">
          ...
          <router-link v-if="can('version-create')" :to="{ name: 'versions.create' }"
...
const {versions, getVersions, deleteVersion} = useVersions()
...
watch(() => versions.value, () => {
  rowData.value = versions.value.data
})
//ag-grid
